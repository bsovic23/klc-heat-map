// Create a page that lists the new updates to version 2.00.01

/*

1. Filter map data by year of interest
2. Whats New tab - to see information about new updates to the application
